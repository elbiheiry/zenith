    ...
    <div class="page-content">
        <div class="widget">
            <div class="widget-content">
                <form class="row ajax-form" action="{{ route('admin.accessories.images.store', ['id' => $id]) }}"
                    method="post">
                    @csrf
                    <div class="col-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="custom-btn btn-modal-view"
                                                    data-url="{{ route('admin.accessories.images.edit', ['id' => $image['id']]) }}">
                                                    <i class="fa fa-edit"></i> Edit
                                                </button>
                                                <button class="custom-btn red-bc delete-btn"
                                                    data-url="{{ route('admin.accessories.images.destroy', ['id' => $image['id']]) }}">
